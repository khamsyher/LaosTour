...
import Package1 from '../../img/attapeu11.jpg'
import Package2 from '../../img/attapeu22.jpg'
import Package3 from '../../img/attapeu33.jpg'
...
export default function attapeuplaces() {
  return (
    <>
            ...
            <div className="row">
                    ...
                    <div className="package-item bg-white mb-2">
                        ...
                        <div className="p-4">
                            <div className="d-flex justify-content-between mb-3">
                                <small className="m-0"><i className="fa fa-map-marker-alt text-primary mr-2"></i>ເມືອງສະໜາມໄຊ</small>
                            ...
                            <a className="h5 text-decoration-none" href="/#">ເປັນແຫຼ່ງທ່ອງທ່ຽວນ້ຳຕົກຕາດທຳມະຊາດທີ່ສວຍງາມທີສຸດເໝາະແກ່ການຍ່າງຊົມວິວແລະກິນເຂົ້າປ່າ.</a>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="package-item bg-white mb-2">
                        ...
                        <div className="p-4">
                            <div className="d-flex justify-content-between mb-3">
                                <small className="m-0"><i className="fa fa-map-marker-alt text-primary mr-2"></i>ເມືອງຊານໄຊ</small>
                                <small className="m-0"><i className="fa fa-calendar-alt text-primary mr-2"></i>3 days</small>
                                <small className="m-0"><i className="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a className="h5 text-decoration-none" href="/#">ໜອງຟ້າ ເປັນໜອງນ້ຳທີ່ໃຫຍ່, ມີແປວທາງນ້ຳໄຫຼ ປ່ອງລົງໃສ່ນ້ຳເຊກະໝານ, ນ້ຳໜອງແຫ່ງນີ້ເປັນສີຂຽວ ຄືນ້ຳທະເລ ແລະ ໃສສະອາດ ສາມາດດື່ມໄດ້ ຄືນ້ຳດື່ມບໍລິສຸດ.</a>
                            <div className="border-top mt-4 pt-4">
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="package-item bg-white mb-2">
                        ...
                        <div className="p-4">
                            ...
                            <a className="h5 text-decoration-none" href="/#">ລູກສອນໄຟໂຊຫວຽດເປັນແລ່ງທ່ອງທ່ຽວທາງປະຫວັດສາດເປັນຮ່ອງຮອຍອະນຸສອນສົງຄາມ ໃນສະໄໝການປະຕິວັດປົດປ່ອຍພາກໃຕ້ຂອງລາວ.</a>
                            <div className="border-top mt-4 pt-4">
