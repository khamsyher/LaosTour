...
import Package1 from '../../img/viengchan1.jpg'
import Package2 from '../../img/veingchan5.jpg'
import Package3 from '../../img/packageimage03.jpg'
import Package4 from '../../img/viengchan4.jpg'
import Package5 from '../../img/viengchan6.jpg'
import Package6 from '../../img/viengchang7.jpg'
import Package7 from '../../img/packageimage04.jpg'
import { Link } from 'react-router-dom';


export default function viengchanplaces() {
  return (
    <>
            ...
            <div className="row">
                    ...
                    <div className="package-item bg-white mb-2">
                        ...
                        <div className="p-4">
                            <div className="d-flex justify-content-between mb-3">
                                <small className="m-0"><i className="fa fa-map-marker-alt text-primary mr-2"></i>ເມືອງວັງວຽງ</small>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="package-item bg-white mb-2">
                        ...
                        <div className="p-4">
                            <div className="d-flex justify-content-between mb-3">
                                <small className="m-0"><i className="fa fa-map-marker-alt text-primary mr-2"></i>ເມືອງເຝືອງ</small>
                                <small className="m-0"><i className="fa fa-calendar-alt text-primary mr-2"></i>3 days</small>
                                <small className="m-0"><i className="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a className="h5 text-decoration-none" href="/#">Discover amazing places of the world with us</a>
