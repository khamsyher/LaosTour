...
import Package1 from '../../img/bokeo1.jpg'
import Package2 from '../../img/bokeo2.jpg'
import Package3 from '../../img/bokeo3.jpg'
import Package4 from '../../img/bokeo4.jpg'
// import Package5 from '../../img/packageimage05.jpg'
// import Package6 from '../../img/packageimage06.jpg'

export default function bokeoplaces() {
  return (
    <>
        ...
        <div className="container pt-5 pb-3">
            <div className="text-center mb-3 pb-3">
                <h6 className="text-primary text-uppercase" style={{letterSpacing: "3px"}}>ນຳສະເໝີແຂວງບໍ່ແກ້ວ</h6>
                    ...
                    <div className="package-item bg-white mb-2">
                        ...
                        <div className="p-4">
                            <div className="d-flex justify-content-between mb-3">
                                <small className="m-0"><i className="fa fa-map-marker-alt text-primary mr-2"></i>Main Street, ຫ້ວຍຊາຍ</small>
