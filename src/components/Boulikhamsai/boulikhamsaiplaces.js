...
export default function boulikhamsaiplaces() {
  return (
    <>
                    ...
                    <div className="package-item bg-white mb-2">
                        ...
                        <div className="p-4">
                            <div className="d-flex justify-content-between mb-3">
                                <small className="m-0"><i className="fa fa-map-marker-alt text-primary mr-2"></i>boulikhamsai</small>
                                <small className="m-0"><i className="fa fa-calendar-alt text-primary mr-2"></i>3 weeks</small>
